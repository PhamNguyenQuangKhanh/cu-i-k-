...
public class Exam {
	...
	public static void main(String[] args) {
		...
		//suất điểm đã random
			...
			System.out.println("Điểm kết thúc của môn A: "+diemKetThucA ); 
			decimalFormat.format(diemKetThucA);
			if (diemKetThucA>= 5) {
			...
			System.out.println("Điểm kết thúc của môn B: "+diemKetThucB ); 
			decimalFormat.format(diemKetThucB);
			if (diemKetThucB>= 5) {
			...
			System.out.println("Điểm kết thúc của môn C: "+diemKetThucC ); 
			decimalFormat.format(diemKetThucC);
			if (diemKetThucC>= 5) {
			...
			System.out.println("Điểm kết thúc của môn D: " + diemKetThucD  ); 
			decimalFormat.format(diemKetThucD);
			if (diemKetThucD>= 5) {
			...
			System.out.println("Điểm kết thúc của môn E: "+ diemKetThucE ); 
			decimalFormat.format(diemKetThucE);
			if (diemKetThucE>= 5) {
			...
			//điểm cuối kì
			System.out.println("Điểm trung bình học kì là:  "+ diemTrungBinh);
			if (diemTrungBinh >= 9) {
				datXepLoai = "Giỏi";
